...
public class TimerAndStopwatch extends JFrame {
    ...
    public TimerAndStopwatch() {
        ...
        getContentPane().setBackground(new Color(197, 230, 247));
        ...
        startButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!running) {
                    ...
                    timer.stop();
                    running = false;
                    startButton.setBackground(Color.PINK); // Set the Start button color to green
        ...
        constraints.gridy = 2;
        constraints.gridwidth = 1; // default GRID WIDTH value
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (running) {
                    ...
                    if (currentTime - startTime >= setDuration) {
                        timer.stop();
                        running = false;
                        startButton.setBackground(Color.pink); // Set the Start button color to pink
                        startButton.setText("Start");
        ...
        startStopwatchButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!stopwatchRunning) {
                    ...
                    stopwatchTimer.stop();
                    stopwatchRunning = false;
                    startStopwatchButton.setBackground(Color.green); // Set the Start Stopwatch button color to light gray
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TimerAndStopwatch().setVisible(true);
            }
        });
    }
}
